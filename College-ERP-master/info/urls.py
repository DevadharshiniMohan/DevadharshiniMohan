...
urlpatterns = [
    ...
    path('office-staff/', views.office_staff, name='office_staff'),
    path('add-office-staff/', views.add_office_staff, name='add_office_staff'),
    path('update-officestaff/<int:ID>', views.update_officestaff, name='update_officestaff'),
    path('delete-officestaff/<int:ID>', views.delete_officestaff, name='delete_officestaff'),
