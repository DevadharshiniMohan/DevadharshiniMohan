...
skills = (
    ...
    ('Professionalism and strong work ethic', 'Professionalism and strong work ethic'),
    ('Oral and written communications skills', 'Oral and written communications skills'),
)
...
class Office_staff(models.Model):
    ...
    Skills = MultiSelectField(max_length= 100, choices=skills)
    Designation = models.CharField(max_length=100, choices=designation, default='Customer Care Executive Jobs')
