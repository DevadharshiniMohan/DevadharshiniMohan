...
from .models import StudentCourse, Marks, User, AttendanceRange, Office_staff
...
class Office_staffAdmin(admin.ModelAdmin):
    list_display = ('ID','Name', 'Sex', 'Designation')
...
admin.site.register(Office_staff, Office_staffAdmin )
